...
export const unidicData = {
  suru: {
    ...
    shiro: [
      'しろ,動詞,非自立可能,*,*,サ行変格,命令形,スル,為る,しろ,シロ,する,スル,和,*,*,*,*,*,*,用,シロ,スル,シロ,スル,0,C5,*',
    ].map(parseToUniDicToken),
  },
  kuru: {
    konai: [
    ...
    koi: [
      '来い,動詞,非自立可能,*,*,カ行変格,命令形,クル,来る,来い,コイ,来る,クル,和,*,*,*,*,*,*,用,コイ,クル,コイ,クル,1,C1,*',
    ].map(parseToUniDicToken),
  },
  ichidan: {
    accented: {
      ...
      hareru: {
        ...
        // TODO: check the rules for these causative and CP forms and add tests
        // for them.
        haresaseru: [
          '晴れ,動詞,一般,*,*,下一段-ラ行,未然形-一般,ハレル,晴れる,晴れ,ハレ,晴れる,ハレル,和,*,*,*,*,*,*,用,ハレ,ハレル,ハレ,ハレル,2,C1,M4@1',
      ...
      miru: {
        ...
        miro: [
          '見ろ,動詞,非自立可能,*,*,上一段-マ行,命令形,ミル,見る,見ろ,ミロ,見る,ミル,和,*,*,*,*,*,*,用,ミロ,ミル,ミロ,ミル,1,C1,*',
        ].map(parseToUniDicToken),
      },
    },
    unaccented: {
      ...
      hajimeru: {
        ...
        hajimero: [
          '始めろ,動詞,非自立可能,*,*,下一段-マ行,命令形,ハジメル,始める,始めろ,ハジメロ,始める,ハジメル,和,*,*,*,*,*,*,用,ハジメロ,ハジメル,ハジメロ,ハジメル,0,C2,*',
        ].map(parseToUniDicToken),
      },
    },
  },
  godan: {
    accented: {
      ...
      tsukuru: {
        ...
        // TODO: -ta, -nai, -te, etc.
        tsukure: [
          '作れ,動詞,一般,*,*,五段-ラ行,命令形,ツクル,作る,作れ,ツクレ,作る,ツクル,和,ツ濁,基本形,*,*,*,*,用,ツクレ,ツクル,ツクレ,ツクル,2,C1,*',
        ].map(parseToUniDicToken),
      },
    },
    unaccented: {
      ...
      iu: {
        ...
        ie: [
          '言え,動詞,一般,*,*,五段-ワア行,命令形,イウ,言う,言え,イエ,言う,イウ,和,*,*,*,*,*,*,用,イエ,イウ,イエ,イウ,0,C2,*',
        ].map(parseToUniDicToken),
      },
    },
  },
